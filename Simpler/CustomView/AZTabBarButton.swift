...
public class AZTabBarButton: UIButton{
    ...
    func addBadge(text: String?, appearnce: BadgeAppearance){
        didAddBadge = true
        badge(text: text, appearance: appearnce)
    }
...
extension AZTabBarButton {
    ...
    private func customizeAsHighlighted(image: UIImage,selectedColor: UIColor,highlightedColor: UIColor,ignoreColor: Bool = false) {
        ...
        self.setImage(ignoreColor ? image : image.withRenderingMode(.alwaysOriginal), for: .normal)
